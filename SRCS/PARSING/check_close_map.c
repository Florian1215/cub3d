...
//	data->start_wall.x = start_wall.x;
//	data->start_wall.y = start_wall.y;
...
//		first_call = FALSE;
//	}
//	else if (data->start_wall.x == c->x && data->start_wall.y == c->y)
//	{
//		return (SUCCESS);
//	}
//	printf("%d - %d | %d - %d\n", c->y, c->x, data->start_wall.x, data->start_wall.y);
//	while (TRUE)
//	{
...
//	while (TRUE)
//	{
//		if (data->start_wall.x == c->x && data->start_wall.y == c->y)
//			return (SUCCESS);
//		printf("UP:    %d | %d - %d\n", data->map[c->y][c->x],  c->y, c->x);
